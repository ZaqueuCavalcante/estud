...
public abstract class ErrorExamplesProvider<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12> : IMultipleExamplesProvider<ErrorOut>
    where T1 : EstudError, new()
    where T2 : EstudError, new()
    where T3 : EstudError, new()
    where T4 : EstudError, new()
    ...
    where T10 : EstudError, new()
    where T11 : EstudError, new()
    where T12 : EstudError, new()
{
    public IEnumerable<SwaggerExample<ErrorOut>> GetExamples() =>
        new EstudError[] { new T1(), new T2(), new T3(), new T4(), new T5(), new T6(), new T7(), new T8(), new T9(), new T10(), new T11(), new T12() }.Select(e => e.ToSwaggerExampleErrorOut());
}

public abstract class ErrorExamplesProvider<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13> : IMultipleExamplesProvider<ErrorOut>
    where T1 : EstudError, new()
    where T2 : EstudError, new()
    where T3 : EstudError, new()
    where T4 : EstudError, new()
    ...
    where T11 : EstudError, new()
    where T12 : EstudError, new()
    where T13 : EstudError, new()
{
    public IEnumerable<SwaggerExample<ErrorOut>> GetExamples() =>
        new EstudError[] { new T1(), new T2(), new T3(), new T4(), new T5(), new T6(), new T7(), new T8(), new T9(), new T10(), new T11(), new T12(), new T13() }.Select(e => e.ToSwaggerExampleErrorOut());
}
