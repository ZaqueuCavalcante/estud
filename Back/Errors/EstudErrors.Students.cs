...
public class EnrollmentProofNotFound : EstudError
{
    public static readonly EnrollmentProofNotFound I = new();
    public override string Code { get; set; } = nameof(EnrollmentProofNotFound);
    public override string Message { get; set; } = "Comprovante de matrícula não encontrado.";
}
