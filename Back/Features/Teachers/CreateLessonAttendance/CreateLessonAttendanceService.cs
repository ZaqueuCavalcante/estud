...
{
    public async Task<OneOf<EstudSuccess, EstudError>> Create(int lessonId, CreateLessonAttendanceIn data)
    {
        ...
        var lesson = await ctx.ClassLessons
            ...
            .FirstOrDefaultAsync(l => l.Id == lessonId && l.Class.InstitutionId == institutionId);
