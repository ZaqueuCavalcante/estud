...
public class GetWebhookSubscriptionController(GetWebhookSubscriptionService service) : ControllerBase
{
    ...
    /// </remarks>
    [HttpGet("webhooks/subscriptions/{subscriptionId}")]
    [SwaggerResponseExample(200, typeof(ResponseExamples))]
    [SwaggerResponseExample(400, typeof(ErrorsExamples))]
    public async Task<IActionResult> Get([FromRoute] int subscriptionId)
    {
        var result = await service.Get(subscriptionId);
