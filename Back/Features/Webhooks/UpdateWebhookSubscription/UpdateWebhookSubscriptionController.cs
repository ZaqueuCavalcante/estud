...
public class UpdateWebhookSubscriptionController(UpdateWebhookSubscriptionService service) : ControllerBase
{
    ...
    /// </remarks>
    [HttpPut("webhooks/subscriptions/{subscriptionId}")]
    [SwaggerResponseExample(200, typeof(ResponseExamples))]
    [SwaggerResponseExample(400, typeof(ErrorsExamples))]
    public async Task<IActionResult> Update([FromRoute] int subscriptionId, [FromBody] UpdateWebhookSubscriptionIn data)
    {
