...
public class GetCoursePotentialDisciplinesController(GetCoursePotentialDisciplinesService service) : ControllerBase
{
    ...
    /// </remarks>
    [HttpGet("courses/{courseId}/potential-disciplines")]
    [SwaggerResponseExample(200, typeof(ResponseExamples))]
    [SwaggerResponseExample(400, typeof(ErrorsExamples))]
    public async Task<IActionResult> Get([FromRoute] int courseId, [FromQuery] string? name)
    {
        var result = await service.Get(courseId, name);
