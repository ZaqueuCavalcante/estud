...
public class UpdateEnrollmentPeriodController(UpdateEnrollmentPeriodService service) : ControllerBase
{
    ...
    /// </remarks>
    [HttpPut("periods/enrollment/{enrollmentPeriodId}")]
    [SwaggerResponseExample(200, typeof(ResponseExamples))]
    [SwaggerResponseExample(400, typeof(ErrorsExamples))]
    public async Task<IActionResult> Update([FromRoute] int enrollmentPeriodId, [FromBody] UpdateEnrollmentPeriodIn data)
    {
        var result = await service.Update(enrollmentPeriodId, data);
