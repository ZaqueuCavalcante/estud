...
public class UpdateCalendarDayController(UpdateCalendarDayService service) : ControllerBase
{
    ...
    /// </remarks>
    [HttpPut("calendar/days/{dayId}")]
    [SwaggerResponseExample(200, typeof(ResponseExamples))]
    [SwaggerResponseExample(400, typeof(ErrorsExamples))]
    public async Task<IActionResult> Update([FromRoute] int dayId, [FromBody] UpdateCalendarDayIn data)
    {
        var result = await service.Update(dayId, data);
