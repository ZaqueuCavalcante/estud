...
public partial class IntegrationTests
{
    ...
    public async Task ScheduleFunctional_Simple_one_online_class()
    {
        ...
        var period = await directorClient.CreateAcademicPeriod().Success();
    ...
    public async Task ScheduleFunctional_One_presential_class()
    {
        ...
        await directorClient.UpdateClassTeachers(@class.Id, [teacher.Id]);
        await directorClient.UpdateClassSchedules(@class.Id, [(Day.Monday, Hour.H07_00, Hour.H10_00, null)]);
        await directorClient.UpdateClassClassrooms(@class.Id, [(Day.Monday, Hour.H07_00, Hour.H10_00, sala01.Id)]);
    ...
    public async Task ScheduleFunctional_One_classroom_two_shifts()
    {
        ...
        await directorClient.UpdateClassSchedules(classA.Id, [(Day.Monday, Hour.H07_00, Hour.H10_00, null)]);
        await directorClient.UpdateClassClassrooms(classA.Id, [(Day.Monday, Hour.H07_00, Hour.H10_00, sala01.Id)]);
        ...
        await directorClient.UpdateClassSchedules(classB.Id, [(Day.Monday, Hour.H19_00, Hour.H22_00, null)]);
        await directorClient.UpdateClassClassrooms(classB.Id, [(Day.Monday, Hour.H19_00, Hour.H22_00, sala01.Id)]);
    ...
    public async Task ScheduleFunctional_One_class_with_many_disciplines_in_the_week()
    {
        ...
        foreach (var (disciplineId, teacherId, day) in week)
        {
            ...
            await directorClient.UpdateClassSchedules(@class.Id, [(day, Hour.H07_00, Hour.H10_00, null)]);
            await directorClient.UpdateClassClassrooms(@class.Id, [(day, Hour.H07_00, Hour.H10_00, sala01.Id)]);
            await directorClient.ReleaseClassForEnrollment(@class.Id);
            await directorClient.AssignStudentToClass(student.Id, @class.Id);
            await directorClient.StartClass(@class.Id);
    ...
    public async Task ScheduleFunctional_Two_classes_two_classrooms()
    {
        ...
        [
            (Day.Tuesday, Hour.H13_00, Hour.H16_00, null),
            (Day.Thursday, Hour.H13_00, Hour.H16_00, null),
        ]);
        await directorClient.UpdateClassClassrooms(secondClass.Id,
        [
            (Day.Tuesday, Hour.H13_00, Hour.H16_00, sala02.Id),
            (Day.Thursday, Hour.H13_00, Hour.H16_00, sala01.Id),
        ]);
    ...
    public async Task ScheduleFunctional_Two_campi()
    {
        ...
        await directorClient.UpdateClassSchedules(geometriaClass.Id, [(Day.Monday, Hour.H07_00, Hour.H10_00, null)]);
        await directorClient.UpdateClassClassrooms(geometriaClass.Id, [(Day.Monday, Hour.H07_00, Hour.H10_00, sala01.Id)]);
        ...
        await directorClient.UpdateClassSchedules(algoritmosClass.Id, [(Day.Tuesday, Hour.H07_00, Hour.H10_00, null)]);
        await directorClient.UpdateClassClassrooms(algoritmosClass.Id, [(Day.Tuesday, Hour.H07_00, Hour.H10_00, sala02.Id)]);
        ...
        await directorClient.UpdateClassSchedules(didaticaClass.Id, [(Day.Monday, Hour.H08_00, Hour.H11_00, null)]);
        await directorClient.UpdateClassClassrooms(didaticaClass.Id, [(Day.Monday, Hour.H08_00, Hour.H11_00, sala03.Id)]);
        ...
        await directorClient.UpdateClassSchedules(psicologiaClass.Id, [(Day.Friday, Hour.H14_00, Hour.H16_00, null)]);
        await directorClient.UpdateClassClassrooms(psicologiaClass.Id, [(Day.Friday, Hour.H14_00, Hour.H16_00, sala04.Id)]);
    ...
    public async Task ScheduleFunctional_Student_with_parent()
    {
        ...
        await directorClient.UpdateClassTeachers(algoritmosClass.Id, [teacherB.Id]);
        await directorClient.UpdateClassSchedules(algoritmosClass.Id, [(Day.Wednesday, Hour.H19_00, Hour.H22_00, null)]);
        await directorClient.UpdateClassClassrooms(algoritmosClass.Id, [(Day.Wednesday, Hour.H19_00, Hour.H22_00, sala02.Id)]);
        await directorClient.ReleaseClassForEnrollment(algoritmosClass.Id);
    ...
    public async Task ScheduleFunctional_Enrollment_period()
    {
        ...
        await directorClient.UpdateClassSchedules(fullClass.Id, [(Day.Monday, Hour.H07_00, Hour.H10_00, null)]);
        await directorClient.UpdateClassClassrooms(fullClass.Id, [(Day.Monday, Hour.H07_00, Hour.H10_00, sala01.Id)]);
        ...
        await directorClient.UpdateClassSchedules(emptyClass.Id, [(Day.Tuesday, Hour.H19_00, Hour.H22_00, null)]);
        await directorClient.UpdateClassClassrooms(emptyClass.Id, [(Day.Tuesday, Hour.H19_00, Hour.H22_00, sala02.Id)]);
    ...
    public async Task ScheduleFunctional_Unbalanced_teachers_workload()
    {
        ...
        foreach (var (disciplineId, day) in disciplines.Take(5).Zip(busyDays))
        {
            ...
            await directorClient.UpdateClassSchedules(@class.Id, [(day, Hour.H07_00, Hour.H11_00, null)]);
            await directorClient.UpdateClassClassrooms(@class.Id, [(day, Hour.H07_00, Hour.H11_00, sala01.Id)]);
            await directorClient.ReleaseClassForEnrollment(@class.Id);
            await directorClient.AssignStudentToClass(student.Id, @class.Id);
            await directorClient.StartClass(@class.Id);
        }
        ...
        await directorClient.UpdateClassSchedules(lightClass.Id, [(Day.Monday, Hour.H19_00, Hour.H21_00, null)]);
        await directorClient.UpdateClassClassrooms(lightClass.Id, [(Day.Monday, Hour.H19_00, Hour.H21_00, sala01.Id)]);
    ...
    public async Task ScheduleFunctional_Complete_institution()
    {
        ...
        foreach (var item in plan)
        {
            ...
            await directorClient.UpdateClassSchedules(@class.Id, [(item.Day, item.Start, item.End, null)]);
            await directorClient.UpdateClassClassrooms(@class.Id, [(item.Day, item.Start, item.End, item.ClassroomId)]);
            await directorClient.ReleaseClassForEnrollment(@class.Id);
            classIds.Add(@class.Id);
        }
