...
const stack: StackRow[] = [
  ...
  { area: 'Integrações', item: 'Webhooks', tech: 'Inscrições por instituição · retry com backoff', note: 'Saída (WebhookCall + Attempt), com histórico em /integrations.' },
