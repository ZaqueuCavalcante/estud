...
const diagrams: Diagram[] = [
  ...
  },
  {
    ...
    nodes: [
      ...
      { id: 'work', label: 'Entrega', sub: 'ClassActivityWork', group: 'effect', x: 516, y: 220, note: 'Uma entrega é criada por aluno matriculado no momento em que a atividade é criada. Nasce Pending e vira Review no primeiro comentário do aluno (CreateClassActivityWorkComment). O professor comenta, muda a nota (0 a 10) e muda o status por CreateClassActivityWorkEntry, e cada uma dessas ações vira um ClassActivityWorkEntry na linha do tempo. Em Finalized o aluno não comenta mais.' },
