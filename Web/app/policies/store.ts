...
function isAdm(): PolicyRequirement {
  return { type: "isAdm" };
}
...
export const Policies: Record<PolicyName, PolicyDefinition> = {
  ...
  GetCampusOpeningHours: {
    description: "Ver os horários de funcionamento de um campus",
    requirements: [
      hasUserType(UserTypes.Manager),
      hasPermission(Permissions.ManageCampi),
    ],
  },
  UpdateCampusOpeningHours: {
    description: "Editar os horários de funcionamento de um campus",
    requirements: [
      hasUserType(UserTypes.Manager),
      hasPermission(Permissions.ManageCampi),
    ],
  ...
  // Periods
  GetAcademicPeriods: {
    description: "Ver os períodos acadêmicos da instituição",
    requirements: [
      hasUserType(UserTypes.Manager),
  ...
  GetEnrollmentPeriods: {
    description: "Ver os períodos de matrícula da instituição",
    requirements: [
      hasUserType(UserTypes.Manager),
      hasPermission(Permissions.ManagePeriods),
    ],
  ...
  UpdateClassSchedules: {
    description: "Definir os horários de uma turma",
    requirements: [
      hasUserType(UserTypes.Manager),
      hasPermission(Permissions.ManageClasses),
    ],
  ...
  GetAdminInstitutions: {
    description: "Listar as instituições de todos os tenants",
    requirements: [
      isAdm(),
    ],
  },
